      ...
      <div class="rounded-2xl border border-border-hover bg-surface p-6 shadow-2xl max-w-md w-full mx-4">
        ...
        <template v-if="!user">
          <div class="text-center py-8">
            ...
            <p class="text-foreground font-medium mb-1">Sign in to publish</p>
            <p class="text-sm text-foreground-muted mb-5">You need an account to share your tier list with the community.</p>
            <a
        ...
        <template v-else>
          ...
          <!-- Visibility -->
          <div class="mb-4">
            <label class="text-xs font-medium text-foreground-muted uppercase tracking-wider mb-2 block">Visibility</label>
